...
SWEP.ViewModel = "models/weapons/insurgency/v_m1911.mdl"
SWEP.WorldModel = "models/weapons/insurgency/w_1911.mdl"
...
function SWEP:DrawModels()
    if CLIENT then
        ...
        self.Mag = ClientsideModel( "models/weapons/insurgency/upgrades/a_magazine_1911_8.mdl", RENDERGROUP_VIEWMODEL )
