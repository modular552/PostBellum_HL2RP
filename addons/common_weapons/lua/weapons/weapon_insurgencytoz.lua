...
SWEP.ViewModel = "models/weapons/insurgency/v_toz.mdl"
SWEP.WorldModel = "models/weapons/insurgency/w_toz.mdl"
...
SWEP.ReloadTimer = 0
SWEP.Active = 0
SWEP.IronSightsPos = Vector( -2.01, 0, 0.9 )
SWEP.IronSightsAng = Vector( 0, 0, 0 )
SWEP.Primary.Cone = 0.02
SWEP.NextSecondaryAttack = 0.2

SWEP.Primary.Sound = Sound( "weapons/toz_shotgun/toz_fp.wav" )
