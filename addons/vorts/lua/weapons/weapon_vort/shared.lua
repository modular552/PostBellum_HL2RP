...
if ( CLIENT ) then
	SWEP.DrawAmmo			= false
	SWEP.PrintName			= "Суперспособности"
	--SWEP.Author				= "ss"
	SWEP.ViewModelFOV		= 54

	SWEP.Instructions = "Первичный огонь: Удар молнией.\nВторичный огонь: Подлечить себя.";
	--SWEP.Contact = "";
	SWEP.Purpose = "Материализует пространственную энергию в мощные разряды тока или целебную силу.";
end
