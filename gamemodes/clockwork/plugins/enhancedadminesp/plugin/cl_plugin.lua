...
Clockwork.setting:AddCheckBox("Валлхак", "Включить валлхак для предметов.", "cwItemESP", "Показывать предметы сквозь стены.", function()
	return Clockwork.player:IsAdmin(Clockwork.Client);
end);
Clockwork.setting:AddCheckBox("Валлхак", "Включить валлхак для пропов.", "cwPropESP", "Показывать пропы сквозь стены.", function()
	return Clockwork.player:IsAdmin(Clockwork.Client);
end);
Clockwork.setting:AddCheckBox("Валлхак", "Включить валлхак для спавнов.", "cwSpawnESP", "Показывать спавны сквозь стены.", function()
	return Clockwork.player:IsAdmin(Clockwork.Client);
end);
Clockwork.setting:AddCheckBox("Валлхак", "Включить валлхак для торговцев.", "cwSaleESP", "Показывать торговцев сквозь стены.", function()
	return Clockwork.player:IsAdmin(Clockwork.Client);
end);
Clockwork.setting:AddCheckBox("Валлхак", "Включить валлхак для энтитей.", "cwEntESP", "Показывать энтити сквозь стены.", function()
	return Clockwork.player:IsAdmin(Clockwork.Client);
end);
Clockwork.setting:AddCheckBox("Валлхак", "Включить валлхак для пианино.", "cwPianoESP", "щееееее?.", function()
	return Clockwork.player:IsAdmin(Clockwork.Client);
end);
Clockwork.setting:AddCheckBox("Валлхак", "Включить валлхак для NPC.", "cwNPCESP", "Показывать NPC сквозь стены.", function()
	return Clockwork.player:IsAdmin(Clockwork.Client);
end);
