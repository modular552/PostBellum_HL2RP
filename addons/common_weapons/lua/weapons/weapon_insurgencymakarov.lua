...
SWEP.ViewModel = "models/weapons/insurgency/v_makarov.mdl"
...
SWEP.Sprint = 0
SWEP.Reloading = 0
SWEP.IronSightsPos = Vector( -1.93, 0, 0.5 )
SWEP.IronSightsAng = Vector( 0, 0, 0 )
SWEP.Primary.Cone = 0.02
SWEP.NextSecondaryAttack = 0.2

SWEP.Primary.Sound = Sound( "weapons/makarov/makarov_fp.wav" )
...
function SWEP:DrawModels()
    if CLIENT then
        ...
        self.Mag = ClientsideModel( "models/weapons/insurgency/upgrades/a_magazine_makarov_8.mdl", RENDERGROUP_VIEWMODEL )
...
if self.Weapon:Clip1() == 1 then
local vm = self.Owner:GetViewModel()
vm:SendViewModelMatchingSequence( vm:LookupSequence( "iron_fire_last" ) )
end
end
