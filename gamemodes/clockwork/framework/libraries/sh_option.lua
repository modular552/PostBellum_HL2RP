...
Clockwork.option:SetKey("description_business", "Покупка различных предметов для персонажа.");
Clockwork.option:SetKey("description_inventory", "Управление предметами в вашем инвентаре.");
Clockwork.option:SetKey("description_directory", "Каталог различной информации.");
Clockwork.option:SetKey("description_system", "Доступ к настройкам сервера.");
Clockwork.option:SetKey("description_scoreboard", "Посмотреть, кто играет на сервере.");
Clockwork.option:SetKey("description_attributes", "Посмотреть состояние ваших навыков.");
...
Clockwork.option:SetKey("name_scoreboard", "Список игроков");
Clockwork.option:SetKey("name_directory", "Справочник");
Clockwork.option:SetKey("name_inventory", "Инвентарь");
Clockwork.option:SetKey("name_business", "Магазин");
...
Clockwork.option:SetKey("name_drop", "Выбросить");
