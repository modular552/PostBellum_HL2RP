...
SWEP.ViewModel = "models/weapons/insurgency/v_akm.mdl"
SWEP.WorldModel = "models/weapons/insurgency/w_akm.mdl"
...
SWEP.Sprint = 0
SWEP.Reloading = 0
SWEP.IronSightsPos = Vector( -2.3, 0, 0.1 )
SWEP.IronSightsAng = Vector( 1.1, 0, 0 )
SWEP.Primary.Cone = 0.02
SWEP.NextSecondaryAttack = 0.2

SWEP.Primary.Sound = Sound( "weapons/ak47/ak47_fp.wav" )
...
function SWEP:DrawModels()
    if CLIENT then
        ...
        self.Standard = ClientsideModel( "models/weapons/insurgency/upgrades/a_standard_akm.mdl", RENDERGROUP_VIEWMODEL )
