...
Clockwork.chatBox:RegisterDefaultClass("ic", "ic", function(info)
	if (info.shouldHear) then
		...
		Clockwork.chatBox:Add(info.filtered, nil, color, info.name.." говорит \""..info.text.."\"");
	end;
end);
...
Clockwork.chatBox:RegisterDefaultClass("yell", "ic", function(info)
	...
	Clockwork.chatBox:Add(info.filtered, nil, color, info.name.." кричит \""..info.text.."\"");
end);
...
Clockwork.chatBox:RegisterDefaultClass("whisper", "ic", function(info)
	if (info.shouldHear) then
		...
		Clockwork.chatBox:Add(info.filtered, nil, color, info.name.." шепчет \""..info.text.."\"");
	end;
end);

Clockwork.chatBox:RegisterDefaultClass("radio", "ic", function(info)
	Clockwork.chatBox:Add(info.filtered, nil, Color(75, 150, 50, 255), info.name.." передает \""..info.text.."\"");
end);
...
Clockwork.chatBox:RegisterDefaultClass("radio_eavesdrop", "ic", function(info)
	if (info.shouldHear) then
		...
		Clockwork.chatBox:Add(info.filtered, nil, color, info.name.." передает \""..info.text.."\"");
	end;
end);
